<p align="center">
  <img src="https://www.fi.uba.ar/images/logo-fiuba.png" alt="image1">
</p>
...
<p align="center"><em>Figura 3: Consola del órgano de tubos de la Catedral Notre Dame de Paris</em></p>
...
flowchart TD
    ...
    A <-- I2C --> B[1. Módulos expansores <br/> I/O para <br/> entradas de teclas o <br/> tiradores de registros]
    A <-- I2C --> C[2. Módulos expansores <br/> I/O para salidas de <br/> LEDs de notas y registros]
    A <-- UART --> D[3. Módulo <br/> Bluetooth ESP32]
...
<p align="center"><em>Tabla 2: Caso de uso 2</em></p>
...
<p align="center"><em>Tabla 2: Caso de uso 3</em></p>